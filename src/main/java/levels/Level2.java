...
public class Level2 extends Level {
    ...
    public Level2(int level, int height, int width, Stage stage, GameMenu menu, Loading1 loading1, Game game, String imagePath, Inventory inventory, String playerGrabGunPath, String playerGunSelfPath, String shootCharPath) {
        super(level, height, width, stage, menu, imagePath, inventory, loading1, game, playerGrabGunPath, playerGunSelfPath, shootCharPath, "resource/levels/level2/npcGrabGun.png", "resource/levels/level2/npcShootPlayer.png", "resource/levels/level2/npcShootSelf.png", "resource/levels/level2/npcDead.png", 3);
